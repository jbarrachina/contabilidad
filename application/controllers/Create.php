...
include "application/controllers/MY_Controller.php";
...
class Create extends MY_Controller {
    ...
    public function index() {
        $this->form_validation->set_rules('url_address', 
                $this->lang->line('create_url_address'), 'required|min_length[1]|max_length[1000]|trim');
